...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddDbContext<IdentityStore>(options =>
            options.UseSqlServer(Configuration.GetConnectionString("IdentityStoreConnectionString")));
        ...
        services.AddPwnedPasswordHttpClient(1)
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, DBInitializer dBInitializer)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            app.UseHealthChecks("/health/live",
                new HealthCheckOptions { Predicate = check => check.Name == "Liveness" });

            app.UseHealthChecks("/health/ready",
                new HealthCheckOptions { Predicate = check => check.Name == "Readiness" });
